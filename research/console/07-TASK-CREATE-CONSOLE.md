...
**Depends on:** Task 1 (FName size), Task 2 (GameViewport/ViewportConsole offsets), Task 3 (Console UClass), Task 4 (ConsoleClass set), Task 6 (`UEngine_callFunction`).
...
- `StaticConstructObject_Internal` located per game (AOB); signature branch resolved from Task 1 (`UEngine.SCOPositionalSig` / FName size).
